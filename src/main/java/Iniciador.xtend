...
//    	  Agua hirviendo
		...
		nicolas.marcarComoFavorita(recetaSalchiPapa)
		leandro.procesamiento = new ProcesamientoOrdenarlosPorNombre
		leandro.filtrosAAplicar.add(filtroGusto)
		leandro.marcarComoFavorita(recetaMilangaConPure)
		
		crearUsuario(leandro)
		crearUsuario(nicolas) 
		
		crearReceta(recetaSalchiPapa)
		crearReceta(recetaPolloAlSpiedo)
		crearReceta(recetaMilangaConPure)
		crearReceta(recetaGrog)
		crearReceta(recetaGrogPosta)
		crearReceta(recetaMilanaga)
		crearReceta(recetaPolloConArroz)
		crearReceta(recetaMilangaConFritas)
		crearReceta(recetaSalchichasConPure)
		crearReceta(recetaPolloGrille)
	}
