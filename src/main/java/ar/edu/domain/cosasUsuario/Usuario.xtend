...
import ar.edu.domain.consulta.Consulta
...
import ar.edu.domain.procesamientoPosterior.ProcesamientoPosterior
...
import ar.edu.domain.repositorioRecetas.BuscaReceta
