...
public class RepositorioRecetas {
  ...
  public Set<Receta> consultar(final BuscaReceta consulta) {
    ...
    String _usuario = consulta.getUsuario();
    final Usuario usuario = _instance.getUserByName(_usuario);
    boolean _isFiltros = consulta.isFiltros();
    boolean _notEquals = (_isFiltros != false);
    if (_notEquals) {
      Set<Receta> _postProcesarRecetas = usuario.postProcesarRecetas();
